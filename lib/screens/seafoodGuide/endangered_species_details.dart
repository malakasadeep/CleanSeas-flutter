...
class EndangeredSpeciesDetailScreen extends StatelessWidget {
  ...
  const EndangeredSpeciesDetailScreen({super.key, required this.endangeredSpecies});
          ...
          children: [
            Stack(
              children: [
                // Image
                Image.asset(
                  endangeredSpecies.imageUrl, // Replace with your image asset
                  height: 300,
                  fit: BoxFit.cover,
                ...
                Positioned(
                  ...
                  left: 16,
                  child: Text(
                    endangeredSpecies.name, // Sea creature name
                    style: TextStyle(
                      fontSize: 32,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    endangeredSpecies.longDescription,
